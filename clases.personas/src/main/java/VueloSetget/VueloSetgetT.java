...
public class VueloSetgetT {
    ...
    public static void main(String[] args){
     VueloSetgetT vuelo1 = new VueloSetgetT(1, 250, "Durango", "Mexico");
     VueloSetgetT vuelo2 = new VueloSetgetT(2, 300, "Mexico", "Cancun");
    ...
    public String toString() {
        return "VueloSetgetT{" + "no_vuelo=" + no_vuelo + ", cant_pasajeros=" + cant_pasajeros + ", origen=" + origen + ", destino=" + destino + ", aerolinea=" + aerolinea + '}';
    }

    public VueloSetgetT(int no_vuelo, int cant_pasajeros, String origen, String aerolinea) {
        this.no_vuelo = no_vuelo;
        this.cant_pasajeros = cant_pasajeros;
        this.origen = origen;
        this.aerolinea = aerolinea;
